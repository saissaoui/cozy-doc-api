...
// BulkInsertDocuments provides a mock function with given fields: docsWrapper, database
func (_m *CouchDbClient) BulkInsertDocuments(docsWrapper models.BulkDocsWrapper, database string) error {
	ret := _m.Called(docsWrapper, database)

	var r0 error
	if rf, ok := ret.Get(0).(func(models.BulkDocsWrapper, string) error); ok {
		r0 = rf(docsWrapper, database)
	} else {
		r0 = ret.Error(0)
	}
